package net.saril.sarilmod.sound;
...
public class ModSounds {
    ...
    public static final SoundEvent FEIN = registerSoundEvent("fein");
    public static final RegistryKey<JukeboxSong> FEIN_KEY =
            RegistryKey.of(RegistryKeys.JUKEBOX_SONG, Identifier.of(SarilMod.MOD_ID,"fein"));

    private static SoundEvent registerSoundEvent(String name) {
        Identifier id = Identifier.of(SarilMod.MOD_ID, name);
        return Registry.register(Registries.SOUND_EVENT, id, SoundEvent.of(id));
    }

    public static void registerSounds() {
        SarilMod.LOGGER.info("Registering Mod Sounds for " + SarilMod.MOD_ID);
    }
}