...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter exporter) {
        ...
        offerSmelting(exporter, SOLAR_SMELTABLE, RecipeCategory.MISC,
                ModItems.UNSTABLE_SOLAR_MATTER, 0.5f, 600, "solar_matter_from_smelting");

        offerBlasting(exporter, SOLAR_SMELTABLE, RecipeCategory.MISC,
        ...
        offerSmithingTrimRecipe(exporter, ModItems.SKL_SMITHING_TEMPLATE, Identifier.of(SarilMod.MOD_ID, "saril"));
