...
public class ModEnchantmentEffects {
    ...
    private static MapCodec<? extends EnchantmentEntityEffect> registerEntityEffect(String name,
        ...
        return Registry.register(Registries.ENCHANTMENT_ENTITY_EFFECT_TYPE, Identifier.of(SarilMod.MOD_ID, name), codec);
    }

    public static void registerEnchantmentEffects() {
        SarilMod.LOGGER.info("Registering Mod Enchantment Effects for " + SarilMod.MOD_ID);
    }
}